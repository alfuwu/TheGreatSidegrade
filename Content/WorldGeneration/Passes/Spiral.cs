...
public class Spiral {
                ...
                if (num822 == num816 || num821 == 0) {
                    for (int num823 = (int) GenVars.worldSurfaceLow; num823 < Main.worldSurface - 1; num823++) {
                        if (Main.tile[num822, num823].HasTile || Main.tile[num822, num823].WallType > 0) {
                            if (num822 == num816) {
                                num821 = 20;
                                SpiralRunner(num822, num823, WorldGen.genRand.Next(150) + 150, makeOrb: true);
                            } else if (WorldGen.genRand.NextBool(35) && num821 == 0) {
                                num821 = 30;
                                bool makeOrb = true;
                                SpiralRunner(num822, num823, WorldGen.genRand.Next(50) + 50, makeOrb);
                            }
    ...
    public static void SpiralRunner(int i, int j, int steps, bool makeOrb = false) {
        bool flag = false;
        bool flag2 = false;
        bool flag3 = false;
        if (!makeOrb)
