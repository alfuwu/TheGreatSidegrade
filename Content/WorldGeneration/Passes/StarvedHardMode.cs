            ...
            for (int k = num4; k < num5; k++) {
                for (int l = num6; l < num7; l++) {
                    if (!((double)(Math.Abs(k - vector.X) + Math.Abs(l - vector.Y)) < num * 0.5 * (1.0 + Main.rand.Next(-10, 11) * 0.015)))
                        continue;
                    if (good) {
                        if (Main.tile[k, l].WallType == (ushort) ModContent.WallType<Walls.Starved.StarvingStone>())
                        ...
                        else if (Main.tile[k, l].WallType == 216 || Main.tile[k, l].WallType == (ushort) ModContent.WallType<Walls.Starved.StarvedUnsafe1>())
                            Main.tile[k, l].WallType = 219;
                        else if (Main.tile[k, l].WallType == 187 || Main.tile[k, l].WallType == (ushort) ModContent.WallType<Walls.Starved.StarvedUnsafe2>())
                        ...
                        if (Main.tile[k, l].WallType == 63 || Main.tile[k, l].WallType == 65 || Main.tile[k, l].WallType == 66 || Main.tile[k, l].WallType == 68)
                            Main.tile[k, l].WallType = (ushort) ModContent.WallType<Walls.Starved.StarvedGrass>();
                        else if (Main.tile[k, l].WallType == 216)
                            Main.tile[k, l].WallType = (ushort) ModContent.WallType<Walls.Starved.StarvedUnsafe1>();
                        else if (Main.tile[k, l].WallType == 187)
                            Main.tile[k, l].WallType = (ushort) ModContent.WallType<Walls.Starved.StarvedUnsafe2>();
