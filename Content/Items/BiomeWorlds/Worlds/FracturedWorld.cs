...
public class FracturedWorld : Subworld {
	...
	public override List<GenPass> Tasks => [new FracturedWorldGenPass()];
...
[ExtendsFromMod("BiomeWorlds", "SubworldLibrary")]
public class FracturedWorldGenPass : BaseWorldGenPass {
    internal override GreatlySidegradedWorld.WorldEvil WorldEvilType => GreatlySidegradedWorld.WorldEvil.Fractured;

    public FracturedWorldGenPass() : base() {
