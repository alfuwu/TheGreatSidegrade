...
public class StarvedWorld : Subworld {
	...
	public override List<GenPass> Tasks => [new StarvedWorldGenPass()];
...
[ExtendsFromMod("BiomeWorlds", "SubworldLibrary")]
public class StarvedWorldGenPass : BaseWorldGenPass {
    internal override GreatlySidegradedWorld.WorldEvil WorldEvilType => GreatlySidegradedWorld.WorldEvil.Starved;

    public StarvedWorldGenPass() : base() {
