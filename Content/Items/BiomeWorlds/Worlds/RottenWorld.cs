...
public class RottenWorld : Subworld {
	...
	public override List<GenPass> Tasks => [new RottenWorldGenPass()];
...
[ExtendsFromMod("BiomeWorlds", "SubworldLibrary")]
public class RottenWorldGenPass : BaseWorldGenPass {
    internal override GreatlySidegradedWorld.WorldEvil WorldEvilType => GreatlySidegradedWorld.WorldEvil.Rotten;

    public RottenWorldGenPass() : base() {
