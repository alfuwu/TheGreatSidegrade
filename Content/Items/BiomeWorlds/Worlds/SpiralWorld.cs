...
public class SpiralWorld : Subworld {
	...
	public override List<GenPass> Tasks => [new SpiralWorldGenPass()];
...
[ExtendsFromMod("BiomeWorlds", "SubworldLibrary")]
public class SpiralWorldGenPass : BaseWorldGenPass {
    internal override GreatlySidegradedWorld.WorldEvil WorldEvilType => GreatlySidegradedWorld.WorldEvil.Spiral;

    public SpiralWorldGenPass() : base() {
