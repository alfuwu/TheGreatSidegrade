...
{
    internal class StarvingTorch : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.DefaultToTorch(ModContent.TileType<TheGreatSidegrade.Content.Tiles.Starved.StarvingTorch>(), 0, false);
            Item.value = 50;
        }
        ...
        public override void HoldItem(Player player)
        {
            ...
            Lighting.AddLight(position, 1f, 0.7f, 0.24f);
        }

        public override void PostUpdate()
        {
            // Create a yellow (1.0, 0.7, 0.24) light when the item is in world, and isn't underwater.
            if (!Item.wet)
                Lighting.AddLight(Item.Center, 1f, 0.7f, 0.24f);
        }
        ...
        public override void AddRecipes()
        {
            CreateRecipe()
                ...
                .AddRecipeGroup(RecipeGroup.RegisterGroup($"{nameof(TheGreatSidegrade)}:StarvedBlock",
                        new RecipeGroup(() => "Starved Block", ModContent.TileType<StarvingStone>())))
